				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="form-label-group">
							<input type="titre" id="inputtitre" class="form-control" placeholder="titre" required="required" autofocus="autofocus" name="titre">
							<label for="input">Titre :</label>
						</div>
						<br>
						<div class="form-label-group">
							<form method="post">
							<textarea id="mytextarea" name="post">votre post</textarea>
						</form>
